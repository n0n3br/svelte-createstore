var app = (function () {
    ...
    var setLoading = function setLoading(module) {
      if (!getState().loading) store.update(function (currentState) {
    ...
    var setError = function setError(error, module) {
      if (getState().error !== error) store.update(function (currentState) {
        return deepMerge(currentState, {
          error: error,
          loading: false
        });
    ...
    var createStore = function createStore(_ref2) {
    ...
    var svelteCreatestore = /*#__PURE__*/Object.freeze({
        __proto__: null,
        createStore: createStore
    });

    const createStore$1 = svelteCreatestore.createStore;
    var createStore_1 = createStore$1;

    var store$1 = createStore_1({
